...
const data = {
  name: chalk.white('               John Laterre'),
  handle: chalk.white('epictete'),
  work: chalk.white('Junior Web Developer @ BeCode.org'),
  npm: chalk.gray('https://npmjs.com/') + chalk.red('~epictete'),
